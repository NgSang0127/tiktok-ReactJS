...
export const HomeIcon = ({ width = '3.2rem', height = '3.2rem', className, isActive }) => {
    if (isActive)
        return (
            <svg
                width={width}
...
export const FollowIcon = ({ width = '3.2rem', height = '3.2rem', className, isActive }) => {
    if (isActive)
        return (
            <svg
                width={width}
...
export const ExploreIcon = ({ width = '3.2rem', height = '3.2rem', className, isActive }) => {
    if (isActive) {
        return (
            <svg
                fill="rgba(254, 44, 85, 1)"
...
export const LiveIcon = ({ width = '3.2rem', height = '3.2rem', className, isActive }) => {
    if (isActive) {
        return (
            <svg
                width={width}
